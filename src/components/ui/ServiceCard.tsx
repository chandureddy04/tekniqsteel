...
export const ServiceCard = ({ icon, title, description, href = '/services' }: ServiceCardProps) => {
  return (
    <article className="card-glow group">
      <div className="text-center">
        <div className="w-16 h-16 bg-accent-100 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:shadow-glow transition-all duration-300">
